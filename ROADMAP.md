...
`@zeta_rt_string_from_byte(i8)` pour `String(Byte)` et
`@zeta_rt_string_from_char(i32)` pour `String(Char)`, verrouillées respectivement par
...
`compile_clang_backend_string_byte_conversion` et
`compile_clang_backend_string_char_conversion`.
