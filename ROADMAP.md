...
- `sequences` : recherche linéaire et binaire, comparaisons, comptage, extrema,
  remplissage, permutation, inversion et tri génériques sur les vues contiguës
  issues de `Vec[T]` ou de tableaux.
