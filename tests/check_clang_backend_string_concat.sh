...
grep -q '@str\.[0-9][0-9]* = private unnamed_addr constant { i64, i64, \[2 x i8\] } { i64 -1, i64 2, \[2 x i8\] c"ze" }' "${output}.ll"
grep -q '@str\.[0-9][0-9]* = private unnamed_addr constant { i64, i64, \[2 x i8\] } { i64 -1, i64 2, \[2 x i8\] c"ta" }' "${output}.ll"
