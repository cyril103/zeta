...
inline constexpr std::string_view Abi = "4";
inline constexpr int InterfaceFormat = 7;
inline constexpr int GenericTokens = 1;
inline constexpr std::string_view ModuleCache = "14";
